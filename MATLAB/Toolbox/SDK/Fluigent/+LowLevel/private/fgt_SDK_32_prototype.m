...
%This function was generated by loadlibrary.m parser version  on Tue Jul 23 16:42:56 2019
...
% unsigned char _stdcall fgt_get_sensorChannelsInfo ( fgt_CHANNEL_INFO info [ 256 ], int sensorType [ 256 ]); 
...
% unsigned char _stdcall fgt_set_sensorCalibration ( unsigned int sensorIndex , int calibration ); 
...
% unsigned char _stdcall fgt_get_sensorCalibration ( unsigned int sensorIndex , int * calibration ); 
...
% unsigned char _stdcall fgt_get_pressureStatus ( unsigned int pressureIndex , int * type , unsigned short * controllerSN , unsigned char * infoCode , char detail [ 140 ]); 
...
% unsigned char _stdcall fgt_get_sensorStatus ( unsigned int sensorIndex , int * type , unsigned short * controllerSN , unsigned char * infoCode , char detail [ 140 ]); 
...
% unsigned char _stdcall fgt_set_TtlMode ( unsigned int TtlIndex , int mode ); 
