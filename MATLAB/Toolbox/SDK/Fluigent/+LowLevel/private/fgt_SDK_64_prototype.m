...
fcns.thunkname{fcnNum}='uint8uint32uint8Thunk';fcns.name{fcnNum}='fgt_set_sensorRegulationInverted'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint8'; fcns.RHS{fcnNum}={'uint32', 'uint8'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint8uint32voidPtrvoidPtrThunk';fcns.name{fcnNum}='fgt_get_differentialPressureRange'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint8'; fcns.RHS{fcnNum}={'uint32', 'singlePtr', 'singlePtr'};fcnNum=fcnNum+1;
% unsigned char  _stdcall  fgt_get_differentialPressure ( unsigned int sensorIndex , float * Pdiff ); 
fcns.thunkname{fcnNum}='uint8uint32voidPtrThunk';fcns.name{fcnNum}='fgt_get_differentialPressure'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint8'; fcns.RHS{fcnNum}={'uint32', 'singlePtr'};fcnNum=fcnNum+1;
% unsigned char  _stdcall  fgt_get_absolutePressureRange ( unsigned int sensorIndex , float * Pmin , float * Pmax ); 
fcns.thunkname{fcnNum}='uint8uint32voidPtrvoidPtrThunk';fcns.name{fcnNum}='fgt_get_absolutePressureRange'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint8'; fcns.RHS{fcnNum}={'uint32', 'singlePtr', 'singlePtr'};fcnNum=fcnNum+1;
% unsigned char  _stdcall  fgt_get_absolutePressure ( unsigned int sensorIndex , float * Pabs ); 
fcns.thunkname{fcnNum}='uint8uint32voidPtrThunk';fcns.name{fcnNum}='fgt_get_absolutePressure'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint8'; fcns.RHS{fcnNum}={'uint32', 'singlePtr'};fcnNum=fcnNum+1;
% unsigned char  _stdcall  fgt_get_sensorBypassValve ( unsigned int sensorIndex , unsigned char * state ); 
fcns.thunkname{fcnNum}='uint8uint32voidPtrThunk';fcns.name{fcnNum}='fgt_get_sensorBypassValve'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint8'; fcns.RHS{fcnNum}={'uint32', 'uint8Ptr'};fcnNum=fcnNum+1;
% unsigned char  _stdcall  fgt_set_sensorBypassValve ( unsigned int sensorIndex , unsigned char state ); 
fcns.thunkname{fcnNum}='uint8uint32uint8Thunk';fcns.name{fcnNum}='fgt_set_sensorBypassValve'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint8'; fcns.RHS{fcnNum}={'uint32', 'uint8'};fcnNum=fcnNum+1;
% unsigned char  _stdcall  fgt_set_log_verbosity ( unsigned int verbosity ); 
fcns.thunkname{fcnNum}='uint8uint32Thunk';fcns.name{fcnNum}='fgt_set_log_verbosity'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint8'; fcns.RHS{fcnNum}={'uint32'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint8uint8uint8uint8Thunk';fcns.name{fcnNum}='fgt_set_log_output_mode'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint8'; fcns.RHS{fcnNum}={'uint8', 'uint8', 'uint8'};fcnNum=fcnNum+1;
% unsigned char  _stdcall  fgt_get_next_log ( char log [ 4000 ]); 
fcns.thunkname{fcnNum}='uint8voidPtrThunk';fcns.name{fcnNum}='fgt_get_next_log'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint8'; fcns.RHS{fcnNum}={'int8Ptr'};fcnNum=fcnNum+1;
